...
class Model{
    ...
    var cursos: [CourseInfo] = [
        CourseInfo(nome: "Como fazer uma Banqueta", nota: 5.5, image: UIImage(named: "Banqueta"), habilidades: ["pregar","parafusar","serrar"], ferramentas: ["Martelo","Serra","Esquadro","Trena","Furadeira","Chave de fenda"], materiais: ["Madeira","Parafusos"], feito: false, trilha: "Marcenaria",nivel: "Novato",image2: UIImage(named: "marcenaria2")),
            ...
            CourseInfo(nome: "Avental", nota: 5.5, image: UIImage(named: "TesteCostura"), habilidades: ["kelvin","gazal","gabs","kevin","lary"],ferramentas: ["martelo","serra"], materiais: ["pao","jiose"], feito: false, trilha: "Costura",nivel: "Intermediário",image2: UIImage(named: "costura2")),
            ...
            CourseInfo(nome: "Calça de moletom", nota: 5.5, image: UIImage(named: "TesteCostura"), habilidades: ["kelvin","gazal","gabs","kevin","lary"],ferramentas: ["martelo","serra"], materiais: ["pao","jiose"], feito: false, trilha: "Costura",nivel: "Intermediário",image2: UIImage(named: "costura2")),
